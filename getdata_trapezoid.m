%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% method for getting trapezoid approximation from sampled data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [kron_x_diffs, x_diffs, xxs, xus, xs, us] = getdata_trapezoid(dim_x, dim_u, intervals, dt, nt, x0, A, B, K0, a, f)
    ...
    for i = 1:intervals
        ...
        [x, u, x_end] = sample_sys((i-1)*dt*ones(1,nt) + linspace(0,dt,nt), dim_u, x0, A, B, K0, a, f); % integrate
        % do quadrature
        [kron_x_diff,x_diff,x_x,x_u,x_int,u_int] = trapezoid(dim_x, dim_u, x,u,dt, nt);
        % save data
