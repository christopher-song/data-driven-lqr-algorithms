%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% method for getting exact data in the forms used by adp and system ID
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [kron_x_diffs, x_diffs, xxs, xus, xs, us] = getdata_exact(dim_x, dim_u, intervals, dt, nt, x0, A, B, K0, a, f)
    ...
    for i = 1:intervals
        [kron_x_diff, x_diff, x_x, x_u, x_int, u_int, x_end] = integrate_sys(dt*[i-1,i], dim_x, dim_u, x0, A, B, K0, a, f); % integrate
        % save data
